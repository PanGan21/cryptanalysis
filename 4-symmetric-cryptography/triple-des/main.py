...
def triple_des(key_1, key_2, message, encryption=True):
    if (encryption):
        return des(des(des(message, key_1, True), key_2, False), key_1, True)
    else:
        return des(des(des(message, key_1, False), key_2, True), key_1, False)
...
def main():
    ...
    cipher_text = triple_des(key_1, key_2, message)
    print(cipher_text)

    decrypted = triple_des(key_1, key_2, cipher_text, encryption=False)
    print(decrypted)
